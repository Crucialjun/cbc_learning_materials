...
class FirebaseStorageMethods{
  ...
  Future<void> uploadfile(BuildContext context,String filename)async {
    FilePickerResult? results = await FilePicker.platform.pickFiles(type: FileType.custom,allowedExtensions: ['pdf']);
    ...
    if(results == null){
      ...
      try{
         ...
         var learningMaterial = LearningMaterial(name: filename, downloadUrl: downloadUrl);
